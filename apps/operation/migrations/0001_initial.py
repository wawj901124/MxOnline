# Generated by Django 2.0.3 on 2018-04-03 04:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_read', models.BooleanField(default=False, verbose_name='是否已读，False-未读，True-已读')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='消息发送时间')),
            ],
            options={
                'verbose_name': '用户消息',
